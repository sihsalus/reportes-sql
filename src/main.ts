...
import { INDICATORS_ACCESS_PRIVILEGE, requirePrivilege, requireSession } from "./middleware/auth.js";
...
// ── Compose public router ─────────────────────────────────────────────
  ...
  publicRouter.use(
    ["/indicadores", "/resultados", "/conceptos", "/metas"],
    requirePrivilege(INDICATORS_ACCESS_PRIVILEGE),
  );
